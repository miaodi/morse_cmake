...
if (FFTW_LIBRARIES)
  ...
  if(NOT TARGET fftw::fftw)
    ...
    set_property(TARGET fftw::fftw APPEND PROPERTY INTERFACE_LINK_LIBRARIES "${FFTW_LIBRARIES} ${FFTW_LIBRARIES_DEP}")
    set_property(TARGET fftw::fftw APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES "${FFTW_INCLUDE_DIRS} ${FFTW_INCLUDE_DIRS_DEP}")
